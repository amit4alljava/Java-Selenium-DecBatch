...
public class TestEmployee {
	...
	public static void main(String[] args) {
		...
		Employee ram = new Employee(1001,"Ram",9999);  // ram is variable of Employee type
		System.out.println(ram.getId()+" "+ram.getSalary());
		//ram.print();
		
		Employee tom =  new Employee(1002,"Tom",4444);
		//tom.print();
		tom.setPhone("2222");
		System.out.println(tom.getId()+" "+tom.getPhone());
